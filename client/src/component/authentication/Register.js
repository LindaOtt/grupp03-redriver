    ...
    if (validation !== false) {
      ...
      userRegister(this.state)
        .then((response) => {
          ...
          return this.props.openSnackBar('Registreringen lyckades! Först att kunna logga in måste du först verifiera din mailadress i det mail som har skickats till dig.')
        }).catch((err) => {
